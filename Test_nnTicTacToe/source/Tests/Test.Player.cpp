...
namespace PlayerTest
{
    ...
    public:
        ...
        // SemiRandomPlayer
        // -----------------------------------------
        TEST_METHOD(SemiRandomPlayer_getTripleCandidate_row)
        {
            ...
            Assert::AreEqual( 1, player.getTripleCandidate(gameCells, CS_PLAYER1, 0, 1, 2));
            Assert::AreEqual(-1, player.getTripleCandidate(gameCells, CS_PLAYER1, 3, 4, 5));
            Assert::AreEqual(-1, player.getTripleCandidate(gameCells, CS_PLAYER1, 6, 7, 8));

            Assert::AreEqual(-1, player.getTripleCandidate(gameCells, CS_PLAYER2, 0, 1, 2));
            Assert::AreEqual( 5, player.getTripleCandidate(gameCells, CS_PLAYER2, 3, 4, 5));
            Assert::AreEqual(-1, player.getTripleCandidate(gameCells, CS_PLAYER2, 6, 7, 8));
        }

        TEST_METHOD(SemiRandomPlayer_getTripleCandidate_column)
        {
            // if a single triple can be completed, the completing cell will be returned
            // _ 1 1
            // 2 1 2
            ...
            SemiRandomPlayer player(0, CellState::CS_PLAYER2);
            Assert::AreEqual(-1, player.getTripleCandidate(gameCells, CS_PLAYER1, 0, 3, 6));
            Assert::AreEqual( 7, player.getTripleCandidate(gameCells, CS_PLAYER1, 1, 4, 7));
            Assert::AreEqual(-1, player.getTripleCandidate(gameCells, CS_PLAYER1, 2, 5, 8));

            Assert::AreEqual( 0, player.getTripleCandidate(gameCells, CS_PLAYER2, 0, 3, 6));
            Assert::AreEqual(-1, player.getTripleCandidate(gameCells, CS_PLAYER2, 1, 4, 7));
            Assert::AreEqual(-1, player.getTripleCandidate(gameCells, CS_PLAYER2, 2, 5, 8));
        }

        TEST_METHOD(SemiRandomPlayer_getTripleCandidate_diagonal)
        {
            // if a single triple can be completed, the completing cell will be returned
            // 2 1 _
            // 2 1 2
            ...
            SemiRandomPlayer player(0, CellState::CS_PLAYER2);
            Assert::AreEqual(-1, player.getTripleCandidate(gameCells, CS_PLAYER1, 0, 4, 8));
            Assert::AreEqual( 2, player.getTripleCandidate(gameCells, CS_PLAYER1, 2, 4, 6));

            Assert::AreEqual(-1, player.getTripleCandidate(gameCells, CS_PLAYER2, 0, 4, 8));
            Assert::AreEqual(-1, player.getTripleCandidate(gameCells, CS_PLAYER2, 2, 4, 6));
        }

        TEST_METHOD(SemiRandomPlayer_getTripleCandidates)
        {
            ...
            SemiRandomPlayer player(9923, CellState::CS_PLAYER2);

            {
                std::vector<int> candidates;
                player.getTripleCandidates(gameCells, CellState::CS_PLAYER1, candidates);
            ...
            {
                std::vector<int> candidates;
                player.getTripleCandidates(gameCells, CellState::CS_PLAYER2, candidates);
